...
export default function MaterialMoldShortageProgress() {
    ...
    const handleMaterialMoldShortageProgressCompleted = () => router.push("/home")
        ...
        >
            <div className="max-w-7xl mx-auto bg-sky-100 p-6 rounded-md">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="flex flex-col space-y-6">
                        <div>
                            <label className="block font-medium mb-2">材料・金型欠品開始時間</label>
                            <TimePicker
                        ...
                        <div>
                            <label className="block font-medium mb-2">材料・金型欠品終了時間</label>
                            <TimePicker
                    ...
                    <div className="flex flex-col space-y-6 md:mt-[60%]">
                        ...
                        <Button
                            ...
                            onClick={handleMaterialMoldShortageProgressCompleted}
                        >
                            材料・金型欠品終了
                        </Button>
                    </div>
