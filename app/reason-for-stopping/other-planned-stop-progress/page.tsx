...
export default function OtherPlannedStopProgress() {
    ...
    const handleOtherPlannedStopCompleted = () => router.push("/home")
        ...
        >
            <div className="max-w-7xl mx-auto bg-sky-100 p-6 rounded-md">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="flex flex-col space-y-6">
                        <div>
                            <label className="block font-medium mb-2">その他計画停止開始時間</label>
                            <TimePicker
                        ...
                        <div>
                            <label className="block font-medium mb-2">その他計画停止終了時間</label>
                            <TimePicker
                    ...
                    <div className="flex flex-col space-y-6 md:mt-[60%]">
                        ...
                        <Button
                            ...
                            onClick={handleOtherPlannedStopCompleted}
                        >
                            その他計画停止終了
                        </Button>
                    </div>
