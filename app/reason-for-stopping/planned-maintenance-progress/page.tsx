...
export default function PlannedMaintenanceProgress() {
    ...
    const handlePlannedMaintenanceCompleted = () => router.push("/home")
        ...
        >
            <div className="max-w-7xl mx-auto bg-sky-100 p-6 rounded-md">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="flex flex-col space-y-6">
                        <div>
                            <label className="block font-medium mb-2">計画保全開始時間</label>
                            <TimePicker
                        ...
                        <div>
                            <label className="block font-medium mb-2">計画保全終了時間</label>
                            <TimePicker
                    ...
                    <div className="flex flex-col space-y-6 md:mt-[60%]">
                        ...
                        <Button
                            ...
                            onClick={handlePlannedMaintenanceCompleted}
                        >
                            計画保全終了
                        </Button>
                    </div>
